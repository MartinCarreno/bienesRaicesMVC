...
<fieldset>
    ...
    <input type="numbre" id="wc" name="propiedad[wc]" placeholder="Ej 3" min="1" max="9" value="<?php echo s($propiedad->wc); ?>">

    <label for="estacionamiento">Estacionamientos:</label>
    <input type="numbre" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ej 3" min="1" max="9" value="<?php echo s($propiedad->estacionamiento); ?>">
